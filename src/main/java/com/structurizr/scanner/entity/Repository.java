...
public class Repository {
    ...
    /**
     * Reason why scanning is disabled (e.g., "irrelevant for architecture landscape", "deprecated", "out of scope")
     * Only populated when isEnabledForScanning is false
     */
    @Column(name = "scan_disabled_reason", length = 500)
    private String scanDisabledReason;

    /**
     * User who disabled scanning for this repository
     */
    @Column(name = "scan_disabled_by", length = 255)
    private String scanDisabledBy;

    /**
     * Timestamp when scanning was disabled
     */
    @Column(name = "scan_disabled_at")
