...
public class ApplicationMapper {
    ...
    public RepositoryDTO toDTO(Repository entity) {
        ...
        dto.setScanDisabledReason(entity.getScanDisabledReason());
        dto.setScanDisabledBy(entity.getScanDisabledBy());
        dto.setScanDisabledAt(entity.getScanDisabledAt());
    ...
    public Repository toEntity(RepositoryDTO dto) {
        ...
        entity.setScanDisabledReason(dto.getScanDisabledReason());
        entity.setScanDisabledBy(dto.getScanDisabledBy());
        entity.setScanDisabledAt(dto.getScanDisabledAt());
